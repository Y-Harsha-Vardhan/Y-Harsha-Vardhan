...
USER_NAME = os.environ['USER_NAME'] # 'Y-Harsha-Vardhan'
...
if __name__ == '__main__':
    """
    Y-Harsha-Vardhan, 2024-2025
    Adapted from Andrew6rant (https://github.com/Andrew6rant)
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2007, 1, 3))
